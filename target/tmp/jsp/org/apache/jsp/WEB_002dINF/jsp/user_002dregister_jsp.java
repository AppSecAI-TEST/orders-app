      ...
      if (_jspx_eval_form_form_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          if (_jspx_meth_form_password_0((javax.servlet.jsp.tagext.JspTag) _jspx_th_form_form_0, _jspx_page_context, _jspx_push_body_count_form_form_0))
            return true;
          out.write("\r\n");
          out.write("\t\t\t<!-- path corresponds to attributes name of object transfering data from the form -->\r\n");
          out.write("\t\t</div>\r\n");
          out.write("\t\t<button type=\"submit\" class=\"btn btn-large btn-primary\">Submit</button>\r\n");
          out.write("\t");
